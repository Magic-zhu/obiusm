(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.obiusm = factory());
    ...
    var EventEmitter = (function () {
        ...
        EventEmitter.on = function (eventName, listener, options) {
            ...
            if (this._events[eventName].length >= this.MAX_LISTENERS) {
                console.error("".concat(eventName, "'s number of listeners has reached the limit"));
                return;
            }
        ...
        EventEmitter.removeListener = function (eventName, listener) {
            if (!(eventName in this._events)) {
                console.warn("there is no event named ".concat(eventName));
                return false;
            }
    ...
    var Obisum = (function (_super) {
        ...
        Obisum.register = function (methodName, method) {
            if (!isUndef(this[methodName])) {
                console.error("".concat(methodName, " has already exist"));
                return;
            }
        ...
        Obisum.keyframe = function (id, keyframe, options) {
            var _this = this;
            this.checkIfHasDomRender(function () {
                var ani = _this.create().keyframe(id, keyframe, options);
                _this.dom(_this.current, ani).render();
            });
            return this;
        };
